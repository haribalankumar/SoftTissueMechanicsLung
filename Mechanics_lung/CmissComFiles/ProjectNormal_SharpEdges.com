...
##ProjectEdges;
##-----------
####em update xi points edge_back faces side2_lung from $njs[1] $njs[2] $njs[3] to_field $njj[1] $njj[2] $njj[3];
...
#ProjectTops;
##---------------
#########em update xi points top faces side2_lung edge from $njs[1] $njs[2] $njs[3] to $njj[1] $njj[2] $njj[3];
###em update xi points top_side_1 faces side2_lung from $njs[1] $njs[2] $njs[3] to $njj[1] $njj[2] $njj[3];
###em update xi points top_side_2 faces side2_lung from $njs[1] $njs[2] $njs[3] to $njj[1] $njj[2] $njj[3];

fem update xi points top_side_1,top_side_2 faces apex_faces from $njs[1] $njs[2] $njs[3] to $njj[1] $njj[2] $njj[3];
...
fem update xi points EdgeNode70_80_89 faces frontaledge_faces edge xi1 0 xi3 0 from $njs[1] $njs[2] $njs[3] to_field $njj[1] $njj[2] $njj[3];



# project Base Edges 
#####################
##em update xi points BaseEdge_Side1 faces side1_lung edge xi2 0 xi3 1 from $njs[1] $njs[2] $njs[3] to $njj[1] $njj[2] $njj[3];
##em update xi points BaseEdge_Side2 faces side2_lung edge xi2 0 xi3 0 from $njs[1] $njs[2] $njs[3] to $njj[1] $njj[2] $njj[3];

####em update xi points BaseEdge_Side1 faces baseMiddleFace from $njs[1] $njs[2] $njs[3] to $njj[1] $njj[2] $njj[3];
####em update xi points BaseEdge_Side2 faces baseMiddleFace from $njs[1] $njs[2] $njs[3] to $njj[1] $njj[2] $njj[3];
