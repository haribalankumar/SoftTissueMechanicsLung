...
###em update xi points EdgeNode70_80_89 faces side2_lung edge xi1 0 xi3 0 from $njs[1] $njs[2] $njs[3] to_field $njj[1] $njj[2] $njj[3];
...
##em update xi points EdgeNode70_80_89 faces frontaledge_faces from $njs[1] $njs[2] $njs[3] to_field $njj[1] $njj[2] $njj[3];

####em update xi points 57 faces frontalcorner_faces from $njs[1] $njs[2] $njs[3] to_field $njj[1] $njj[2] $njj[3];
