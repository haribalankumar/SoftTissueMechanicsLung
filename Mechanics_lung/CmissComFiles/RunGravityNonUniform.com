...
$GravNonUniform='GravitySoln';
fem def init;w;${init_path}.'/'.$GravNonUniform.${lung}.'_'.$volume;
...
#############################################################
fem update field 2 substitute geometry x; 
fem update field 3 substitute geometry y;
fem update field 4 substitute geometry z;

fem update field 5 substitute solution depvar 1;
fem update field 6 substitute solution depvar 2;
fem update field 7 substitute solution depvar 3;
...
##Fem def xi;w;$xifile;
#FFFem de data;c fill_volume; ! and this also generates the xi locations of the data points (stored)

fem update geometry x substitute field 2;
fem update geometry y substitute field 3;
fem update geometry z substitute field 4;

fem update solution depvar 1 substitute field 5;
fem update solution depvar 2 substitute field 6;
fem update solution depvar 3 substitute field 7;
